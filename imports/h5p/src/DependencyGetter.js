...
var DependencyGetter = /** @class */ (function () {
    function DependencyGetter(libraryManager) {
     ...
     */
    DependencyGetter.prototype.getDependentLibraries = function (libraries, _a) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.addDependenciesRecursive(new LibraryName_1["default"](library.machineName, library.majorVersion, library.minorVersion), { preloaded: preloaded, editor: editor, dynamic: dynamic }, dependencies)];
                    case 2:
                        _e.sent();
                        _e.label = 3;
                    case 3:
     ...
     */
    DependencyGetter.prototype.addDependenciesRecursive = function (library, _a, libraries) {
        var _b = _a.dynamic, dynamic = _b === void 0 ? false : _b, _c = _a.editor, editor = _c === void 0 ? false : _c, _d = _a.preloaded, preloaded = _d === void 0 ? false : _d;
        return __awaiter(this, void 0, void 0, function () {
            var metadata;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.libraryManager.loadLibrary(library)];
                    case 1:
                        metadata = _e.sent();
                        if (!(preloaded && metadata.preloadedDependencies)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _e.label = 3;
                    case 3:
                        if (!(editor && metadata.editorDependencies)) return [3 /*break*/, 5];
                    ...
                    case 4:
                        ...
                        _e.label = 5;
                    case 5:
                        if (!(dynamic && metadata.dynamicDependencies)) return [3 /*break*/, 7];
     ...
     */
    DependencyGetter.prototype.addDependenciesToSet = function (dependencies, _a, libraries) {
        var _b = _a.dynamic, dynamic = _b === void 0 ? false : _b, _c = _a.editor, editor = _c === void 0 ? false : _c, _d = _a.preloaded, preloaded = _d === void 0 ? false : _d;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.addDependenciesRecursive(new LibraryName_1["default"](dependency.machineName, dependency.majorVersion, dependency.minorVersion), { preloaded: preloaded, editor: editor, dynamic: dynamic }, libraries)];
                    case 2:
                        _e.sent();
                        _e.label = 3;
                    case 3:
