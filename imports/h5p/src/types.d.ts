...
export interface IContentStorage {
     ...
     */
    addContentFile(contentId: ContentId, filename: string, readStream: Stream, user?: IUser): Promise<void>;
    /**
     ...
     */
    createContent(metadata: IContentMetadata, content: any, user: IUser, contentId?: ContentId): Promise<ContentId>;
    /**
     ...
     */
    getContentFileStream(contentId: ContentId, file: string, user: IUser): ReadStream;
    /**
...
export interface ILibraryStorage {
     ...
     */
    addLibraryFile(library: ILibraryName, fileLocalPath: string, readStream: Stream): Promise<boolean>;
    /**
     ...
     */
    installLibrary(libraryData: ILibraryMetadata, restricted: boolean): Promise<IInstalledLibrary>;
    /**
 ...
 */
export declare type ContentParameters = any;
/**
 ...
 */
export declare type ILibraryLoader = (machineName: string, majorVersion: number, minorVersion: number) => IInstalledLibrary;
 ...
 */
export declare type ILibraryFileUrlResolver = (library: ILibraryName, filename: string) => string;
/**
