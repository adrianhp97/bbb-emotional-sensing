...
var TemporaryFileManager = /** @class */ (function () {
     ...
     */
    TemporaryFileManager.prototype.getFileStream = function (filename, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                log.info("Getting temporary file " + filename);
                return [2 /*return*/, this.storage.getFileStream(filename, user)];
            });
        });
    };
    /**
     ...
     */
    TemporaryFileManager.prototype.saveFile = function (filename, dataStream, user) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TemporaryFileManager.prototype.generateUniqueName = function (filename, user) {
        return __awaiter(this, void 0, void 0, function () {
            var attempts, filenameAttempt, exists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        attempts = 0;
                        ...
                        _a.label = 1;
                    case 1:
                        filenameAttempt = path_1["default"].basename(filename, path_1["default"].extname(filename)) + "-" + shortid_1["default"]() + path_1["default"].extname(filename);
                    ...
                    case 4:
                        if (exists) {
                            ...
                            throw new H5pError_1["default"]("Cannot determine a unique filename for " + filename);
                        }
