...
export declare class ValidatorBuilder {
     ...
     */
    addRule(rule: (content: any, error: ValidationError) => any): ValidatorBuilder;
    /**
     ...
     * @returns {ValidatorBuilder}
     */
    addRuleWhen(rule: (content: any, error: ValidationError) => any, condition: boolean): ValidatorBuilder;
    /**
     ...
     */
    validate(data: any, error?: ValidationError): Promise<any>;
}
/**
 ...
 */
export declare function throwErrorsNowRule(data: any, error: ValidationError): any;
