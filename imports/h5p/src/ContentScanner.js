...
var ContentScanner = /** @class */ (function () {
    ...
    ContentScanner.prototype.scanContent = function (params, mainLibraryName, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        log.info("scanning content for of type " + LibraryName_1["default"].toUberName(mainLibraryName));
                        return [4 /*yield*/, this.libraryManager.loadSemantics(mainLibraryName)];
                    case 1:
     ...
     */
    ContentScanner.prototype.walkEntryRecursive = function (elementSemantics, elementParams, parentJsonPath, callback, doNotAddNameToJsonPath) {
        if (doNotAddNameToJsonPath === void 0) { doNotAddNameToJsonPath = false; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        currentJsonPath = doNotAddNameToJsonPath
                            ? parentJsonPath
                        ...
                        return [4 /*yield*/, this.walkEntryRecursive(elementSemantics.fields[0], elementParams, doNotAddNameToJsonPath
                                ? parentJsonPath
                                : parentJsonPath + "." + elementSemantics.name, callback, true // we have already added the parent's name to the JSON path, so
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.libraryManager.loadSemantics(subLibraryName)];
                    case 4:
                        subSemantics = _d.sent();
                        return [4 /*yield*/, this.walkSemanticsRecursive(subSemantics, elementParams.params, currentJsonPath + ".params", callback)];
                    case 5:
                        _d.sent();
                        return [3 /*break*/, 16];
                    case 6:
                    ...
                    case 7:
                        ...
                        groupElement = _b[_i];
                        return [4 /*yield*/, this.walkEntryRecursive(groupElement, elementParams[groupElement.name], currentJsonPath, callback)];
                    case 8:
                        _d.sent();
                        _d.label = 9;
                    case 9:
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, this.walkEntryRecursive(elementSemantics.field, listElement, currentJsonPath + "[" + counter + "]", callback, true // we don't want the field name of a list to be added to the JSON path
                            )];
                    case 13:
                        _d.sent();
                        counter += 1;
     ...
     */
    ContentScanner.prototype.walkSemanticsRecursive = function (semantics, params, parentJsonPath, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.walkEntryRecursive(semanticEntry, params[semanticEntry.name], parentJsonPath, callback)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
