...
var ContentTypeInformationRepository = /** @class */ (function () {
     ...
     */
    function ContentTypeInformationRepository(contentTypeCache, storage, libraryManager, config, translationService) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        cachedHubInfo = _b.sent();
                        return [4 /*yield*/, this.addLocalLibraries(cachedHubInfo, user)];
                    case 3:
                        cachedHubInfo = _b.sent();
                        _a = {
     ...
     */
    ContentTypeInformationRepository.prototype.install = function (machineName, user) {
        return __awaiter(this, void 0, void 0, function () {
            var localContentType, response;
            var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!machineName) {
                            ...
                            throw new H5pError_1["default"](this.translationService.getTranslation('hub-install-no-content-type'));
                        }
                    ...
                    case 1:
                        ...
                        if (!localContentType || localContentType.length === 0) {
                            ...
                            throw new H5pError_1["default"](this.translationService.getTranslation('hub-install-invalid-content-type'));
                        }
                        ...
                        if (!this.canInstallLibrary(localContentType[0], user)) {
                            ...
                            throw new H5pError_1["default"](this.translationService.getTranslation('hub-install-denied'));
                        }
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            ...
                                            case 3:
                                                error_1 = _b.sent();
                                                log.error(error_1);
                                                throw new H5pError_1["default"](this.translationService.getTranslation('hub-install-download-failed'));
                                            case 4:
                                                packageImporter = new PackageImporter_1["default"](this.libraryManager, this.translationService, this.config);
    ...
    ContentTypeInformationRepository.prototype.addLocalLibraries = function (hubInfo, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.libraryManager.getInstalled()];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.libraryManager.getInstalled()];
                    case 1:
                        localLibsWrapped = _a.sent();
                        localLibs = Object.keys(localLibsWrapped).map(function (machineName) {
                            return localLibsWrapped[machineName][localLibsWrapped[machineName].length - 1];
                        });
                        return [4 /*yield*/, Promise.all(hubInfo.map(function (hl) { return __awaiter(_this, void 0, void 0, function () {
