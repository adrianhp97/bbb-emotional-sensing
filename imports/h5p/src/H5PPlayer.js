...
var H5PPlayer = /** @class */ (function () {
    function H5PPlayer(libraryLoader, urls, integration, content, customScripts) {
        ...
        this.urls = __assign({ baseUrl: '/html5client/h5p', downloadUrl: '/html5client/download', libraryUrl: "/html5client/h5p/libraries", scriptUrl: "/html5client/h5p/core/js", stylesUrl: "/html5client/h5p/core/styles" }, urls);
